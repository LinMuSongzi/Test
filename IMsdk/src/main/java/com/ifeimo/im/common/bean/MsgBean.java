...
public class MsgBean {
    ...
    public static MsgBean createByCursor(Cursor cursor){
        ...
        msgBean.setId(cursor.getInt(cursor.getColumnIndex(ChatProvider.DB_ID)));
        msgBean.setReceiverId(cursor.getString(cursor.getColumnIndex(ChatProvider.DB_RECEIVER_ID)));
        msgBean.setSendType(cursor.getInt(cursor.getColumnIndex(ChatProvider.DB_SEND_TYPE)));
        msgBean.setMemberId(cursor.getString(cursor.getColumnIndex(ChatProvider.DB_MEMBER_ID)));
        msgBean.setContent(cursor.getString(cursor.getColumnIndex(ChatProvider.DB_CONTENT)));
        msgBean.setCreateTime(cursor.getString(cursor.getColumnIndex(ChatProvider.DB_CREATE_TIME)));
        return msgBean;
